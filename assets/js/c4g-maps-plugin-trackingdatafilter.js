    ...
    doRequest: function(id, varRequestParam) {
      ...
      testObject = {
        content: [
          {
            data: {
              url: "system/modules/con4gis_core/api/index.php/trackingService?method=getBoxTrack" + varRequestParam['structParams']['urlParam'] + (varRequestParam['filter'] ? varRequestParam['filter'] : '')
            },
            format: "GeoJSON",
